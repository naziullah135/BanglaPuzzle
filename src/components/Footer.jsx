...
const Footer = () => {
  return (
    ...
    <div>
    <div className="flex gap-4 md:place-self-center p-16 text-white justify-center">
            <a>
              <svg
      ...
      <footer className="footer grid-cols-3 p-10 justify-center">
        <div >
        ...
        <div>
          <span className="footer-title">Privacy And Terms</span>
